...
private:
	...
	std::map<string,Table*> table_map; //table_ptr is pointer to a pointer array of type 'Table'
...
public:
	...
	// 	}
	// }
	void add_table(string name,Table *pt)
	{
		table_map[name] = pt;
	}
	///////////////////////////////////////////////////////////////////////////////
	...
	//030717 Created by Peter H Zipfel
	///////////////////////////////////////////////////////////////////////////////
	double interpolate(int ind,int ind2,string &name,double val);
	...
	///////////////////////////////////////////////////////////////////////////////
	double interpolate(int ind10,int ind11,int ind20,int ind21,string &name,double value1,double value2);																
