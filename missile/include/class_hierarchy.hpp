...
public:
	...
	virtual void set_vehicle_data(int missile_type, bool init) = 0;
	virtual void vehicle_data_init(double* arr, int length) = 0;
	virtual void vehicle_Reset() = 0;
	virtual double vehicle_data_OUT(char* name) = 0;
	virtual void vehicle_data_Input(char* name, double data) = 0;
	// virtual void read_tables(char* file_name, char* file_path, Datadeck& datatable) = 0;
	...
	virtual void propulsion(double max_mprop_time) = 0;
	...
	virtual void guidance( int num_vehicles) = 0;
	virtual void def_seeker() = 0;
	virtual void seeker(int num_vehicles, double int_step, double* arr, int length, float start_time) = 0;
...
public:
	...
	virtual void set_vehicle_data(int missile_type, bool init);
	virtual void vehicle_Reset();
	virtual void vehicle_data_init(double* arr, int length);
	virtual double vehicle_data_OUT(char* name);
	virtual void vehicle_data_Input(char* name, double data);
	...
	virtual void propulsion(double max_mprop_time);
	...
	virtual void guidance(int num_vehicles);
	virtual void def_seeker();
	virtual void seeker(int num_vehicles, double int_step, double* arr, int length, float start_time);
...
public:
	...
	virtual double vehicle_data_OUT(char* name);
	virtual void vehicle_data_Input(char* name, double data) {};
	virtual void read_tables(char* file_name, char* file_path, Datadeck& datatable) {};
	virtual void com_index_arrays();
	virtual void document(ostream& fdoc, char* title, Document* doc_vehicle);
	virtual Packet loading_packet_init(int num_missile, int num_target);
	virtual Packet loading_packet(int num_missile, int num_target);
	...
	virtual void seeker( int num_vehicles, double int_step, double* arr, int length, float start_time) {};
	virtual void def_intercept() {};
	virtual void intercept( int vehicle_slot, double int_step, char* title) {};
