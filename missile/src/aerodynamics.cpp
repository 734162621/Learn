...
void Missile::aerodynamics()
{
    ...
    ca=ca0+caa*alppx+cad*deff*deff+(1-mprop)*caoff;  //alppx
	...
	cndq=aerotable.look_up("cndq_vs_mach_alpha",vmach,alppx);
...
//		{
//#pragma omp section  
//			 cn0p = aerotable.look_up("cn0_vs_mach_alpha", vmach, alpp);
//#pragma omp section 
//			 cn0m = aerotable.look_up("cn0_vs_mach_alpha", vmach, alpm);
//#pragma omp section 
//			 clm0p = aerotable.look_up("clm0_vs_mach_alpha", vmach, alpp);
//#pragma omp section 
//			 clm0m = aerotable.look_up("clm0_vs_mach_alpha", vmach, alpm);
//		}
