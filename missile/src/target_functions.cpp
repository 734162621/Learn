...
// void Target::vehicle_data(fstream &input,char* file_path,bool init)
// {
...
void Target::vehicle_data_init(double* arr, int length) {


}


double Target::vehicle_data_OUT(char* name) {
	return 0;
}

void Target::vehicle_Reset() {
