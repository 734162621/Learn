...
import jsbsim
from pyaircombat.plane.jsbsim_catalog import JsbsimCatalog as Catalog
from pyaircombat.plane.property import Property, CustomProperty
...
class Simulation:
    ...
    def __init__(self, aircraft_name="A320", init_conditions=None, jsbsim_freq=60, agent_interaction_steps=5):
        ...
        # self.jsbsim_exec = jsbsim.FGFDMExec(None)
