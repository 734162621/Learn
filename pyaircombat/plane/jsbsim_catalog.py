...
class JsbsimCatalog(Property, Enum):
    ...
    attitude_pitch_deg = Property("attitude/pitch-deg", "pitch [deg]", access="R")
    ...
    attitude_roll_deg = Property("attitude/roll-deg", "roll [deg]", 0, 360, access="R")
    ...
    def update_detect_extreme_state(sim):
        ...
        attitude = sim.get_property_value(JsbsimCatalog.position_h_sl_ft)
        extreme_altitude = attitude >= 1e10 or attitude <= 30
        ...
        sim.set_property_value(
            JsbsimCatalog.detect_extreme_state,
            extreme_altitude or extreme_rotation or extreme_velocity or extreme_acceleration,
        )

    detect_extreme_state = Property("detect/extreme-state", "detect extreme rotation, velocity and altitude", 0, 1,
                                    spaces=Discrete, access="R", update=update_detect_extreme_state,
                                    )
